...
public class SearchNewsListAdapter extends RecyclerView.Adapter<SearchNewsListAdapter.NewViewHolder>{
    ...
    public SearchNewsListAdapter(Context context, NewsList newsList)
    {
    ...
    public NewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.news_search_item_layout, parent, false);
